...
var projects = {
    ...
    */
    projects: [{
        'title': 'HomePage',
        'date': 'May, 2015',
        'description': 'I built a homepage to display my projects of the ' +
        'Nanodegree course in this project. I learnt how to use html5 and ' +
        'css ' + 'to build a basic website framework.',
        'pic': 'images/project1.png'
    }, {
        'title': 'Resume',
        'date': 'June, 2015',
        'description': 'This project is to build this resume that you are ' +
        'looking at. With this project, I learnt the basic of using' +
        'javascript and jQurry.',
